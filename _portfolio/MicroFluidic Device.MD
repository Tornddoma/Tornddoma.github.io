...
* **Application Requiring the Sorting of Small Particles** One application that requires the sorting of small particles that can be achieved through microfluidic devices are cell and particle sorting. This type of sorting is required in areas such as biology, biomedicince, and chemistry where cell and particle isolation, separation, and focusing are key aspects of research and testing.
